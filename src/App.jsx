...
function App() {
  ...
  return (
    ...
    <div className="bg-white flex justify-end gap-12 py-3 rounded-sm text-[25px] text-[#344151]">
    ...
    <button onClick={resetHandler} className="bg-[#0398d4] text-white px-5 py-2 rounded-sm text-large">Reset</button>
    </div>
  );
}
